...
import com.example.demoheroku.model.service.impl.UserDetailsServiceImpl;
import com.example.demoheroku.security.JwtAuthEntryPoint;
import com.example.demoheroku.security.JwtAuthFilter;
...
public class SecurityConfiguration {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests() // links start with /api/
                ...
                .permitAll();
        http.authorizeHttpRequests() // links start with /api/
                .antMatchers(HttpMethod.GET,"api/car/list","api/car/detail/**") // perform segregate authorize
                .permitAll();
